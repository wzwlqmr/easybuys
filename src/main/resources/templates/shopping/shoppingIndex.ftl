...
<div id="header" class="wrap">
    ...
    <div class="help"><a href="/shopping/toShopingCart" class="shopping">购物车</a><a href="login.html">登录</a><a href="register.html">注册</a><a href="guestbook.html">留言</a></div>
    <div class="navbar">
        <ul class="clearfix">
            ...
            <ul class="product clearfix">
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a1','法国德菲丝松露精品巧克力500g',1)">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a2','乐扣普通型保鲜盒圣诞7件套',1)">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <dd class="price">
                            <#--  加入购物车按钮 -->
                            <input type="button" value="加入购物车" onclick=" addShopCart('a3','欧珀莱均衡保湿四件套',1)">
                        </dd>
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a4','联想笔记本电脑 高速独立显存',1)">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a5','法姿韩版显瘦彩边时尚牛仔铅笔裤',1)">
                        <input type="button" value="抢抢抢" onclick="toShoppingSale('a')">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <dd class="price">￥69.90</dd>
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a6','Genius925纯银施华洛世奇水晶吊坠',1)">
                        <input type="button" value="抢抢抢" onclick="toShoppingSale('a5')">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a7','利仁2018M福满堂电饼铛 好用实惠',1)">
                        <input type="button" value="抢抢抢" onclick="toShoppingSale('a7')">
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <#--  加入购物车按钮 -->
                        <input type="button" value="加入购物车" onclick="addShopCart('a8','达派高档拉杆箱20寸 经典款式',1)">
                        <input type="button" value="抢抢抢" onclick="toShoppingSale('a8')">
                    </dl>
                </li>
            </ul>
        </div>
...
<div id="footer">
    Copyright &copy; 2010 wzw All Rights Reserved. 京ICP证1000001号
    <button onclick="testCookie()">测试cookie</button>
</div>
<script>
    
    //去抢购页面
    function toShoppingSale(id) {
        location.href="/shopping/shoppingSale?good_id="+id;
    }
    ...
    /*加入购物车*/
    function addShopCart(id,name,count) {
        // 判断用户是否登陆
        //   通过session判断用户是否存在
        $.ajax({
            url:"/shopping/isLogin",
            data:{},
            dataType:"json",
            type:"post",
            success:function(data){
                ...
                // 添加购物车  进行用户未登陆 即游客身份下的业务逻辑处理
                if (data.errorCode==201){
                    var dateExpires1 = dataExpire(0.01);
                    console.log(dateExpires1);
                    //添加进cookie
                    document.cookie=id+"="+count+","+name+";"+dateExpires1;
                    console.log(document.cookie);
                }
            },
            error:function(data){
